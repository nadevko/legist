...
const docTemplate = `{
    ...
    "tags": [
        ...
        {
            "description": "File versions at ` + "`" + `/files` + "`" + `: upload, list, get (JSON, legist, binary, SSE), patch expression-level metadata, delete.",
            "name": "Files"
        },
        {
